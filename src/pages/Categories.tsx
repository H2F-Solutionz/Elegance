...
import { getByCategory, getBySubCategory, Product } from '@/data/products';
...
const Categories: React.FC = () => {
  ...
  const products = useMemo(() => {
    ...
    const categoryProducts = getByCategory(category as Product['category']);
